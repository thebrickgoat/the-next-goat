...
export default function Work({ work }) {
  ...
  return (
    <section id="Work" className="scroll-mt-16">
      ...
      <div
        className={`transition-color duration-500 ease-in-out ${selectedCategory === "All"
            ? "bg-work-800"
              ...
              >
                  ...
                  <div className="flex flex-wrap gap-2 mt-4">
                    {card.tags.map((tag) => (
                      <span
                        key={tag}
                        className={`px-2 py-1 transition-color duration-500 ease-in-out ${selectedCategory === "All"
                            ? "bg-work-800"
                            : `bg-work-${5 + uniqueCategories.indexOf(selectedCategory)
                            }00`
