...
export default function Work() {
    ...
    return (
        <section id='Work'>
            <div className='p-8'>
                <h2 className='pb-8 font-bold text-6xl'>WORK</h2>
            ...
            <div className="flex space-x-4 p-8">
                <button className={`px-4 py-2 shadow-md rounded ${selectedCategory === 'All' ? 'bg-work-300 text-white' : 'bg-white text-black'}`} onClick={() => setSelectedCategory('All')}>All</button>
                <button className={`px-4 py-2 shadow-md rounded ${selectedCategory === 'Category 1' ? 'bg-work-600 text-white' : 'bg-white text-black'}`} onClick={() => setSelectedCategory('Category 1')}>Category 1</button>
                <button className={`px-4 py-2 shadow-md rounded ${selectedCategory === 'Category 2' ? 'bg-work-900 text-white' : 'bg-white text-black'}`} onClick={() => setSelectedCategory('Category 2')}>Category 2</button>
